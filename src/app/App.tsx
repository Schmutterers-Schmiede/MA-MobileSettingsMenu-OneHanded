...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header — plain flex child now, not position:sticky, since sticky
            positioning inside a scaled ancestor is unnecessary complexity here */}
        ...
        {/* Content, scrollable within the fixed-size box */}
